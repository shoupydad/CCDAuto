/*
    ...
    Version 4.35 - December 10, 2003

	(c)1995-2003 - Santa Barbara Instrument Group
...
typedef enum {
	...
	CE_CFW_ERROR, CE_NEXT_ERROR} PAR_ERROR;
...
typedef enum { DCP_USB_FIFO_ENABLE, DCP_CALL_JOURNAL_ENABLE,
	...
	DCP_USB_PIXEL_DL_ENABLE, DCP_HIGH_THROUGHPUT, DCP_LAST } DRIVER_CONTROL_PARAM;
...
typedef enum { CFWSEL_UNKNOWN, CFWSEL_CFW2, CFWSEL_CFW5, CFWSEL_CFW8, CFWSEL_CFWL,
	CFWSEL_CFWF, CFWSEL_AUTO } CFW_MODEL_SELECT;
...
typedef enum { CFWE_NONE, CFWE_BUSY, CFWE_BAD_COMMAND, CFWE_CAL_ERROR, CFWE_MOTOR_TIMEOUT,
				CFWE_BAD_MODEL} CFW_ERROR;
typedef enum { CFWP_UNKNOWN, CFWP_1, CFWP_2, CFWP_3, CFWP_4, CFWP_5, CFWP_6 } CFW_POSITION;
...
#define MIN_STF_EXPOSURE	 4	/* Minimum exposure in 1/100ths second */
