...
// Description: Contains function prototypes for kernel LPT code.
// Author     : Matt Longmire - SBIG
// Co-Author  : Jan Soldan - rewrites src. code for the linux
// Copyright (C) 2002 Matt Longmire - SBIG, Jan Soldan
// All rights reserved.
//========================================================================
