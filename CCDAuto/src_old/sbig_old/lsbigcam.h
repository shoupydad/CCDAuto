...
// Copyright (C) 1999-2003 Jan Soldan, 251 65 Ondrejov-236, Czech Republic
// All rights reserved.
//=============================================================================
...
protected:
 ...
 //unsigned long            m_readout_t0, m_readout_t1;
 //float                    m_readout_tdiff;
 ...
 */
 ...
 //inline float  GetReadoutTime()     {return(m_readout_tdiff);    }
