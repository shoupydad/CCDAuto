/*
	...
	(c)1995-2001 - Santa Barbara Instrument Group
...
*/
 ...
 #define TARGET			ENV_DOS			/* Set for your target */
#endif
...
typedef enum {
	...
	*/
	...
	CC_GET_AD, CC_CLOCK_AD, CC_LAST_COMMAND} PAR_COMMAND;
...
typedef enum { CCD_INFO_IMAGING, CCD_INFO_TRACKING,
	CCD_INFO_EXTENDED, CCD_INFO_EXTENDED_5C } CCD_INFO_REQUEST;
...
typedef enum { DEV_NONE, DEV_LPT1, DEV_LPT2, DEV_LPT3,
  DEV_USB=0x7F00, DEV_ETH } SBIG_DEVICE_TYPE;
/*
...
typedef enum { MOVE_STOP, MOVE_BASE, MOVE_LEAVE, MOVE_0R5X, MOVE_1X,
	...
	MOVE_128X, MOVE_256X, MOVE_SLEW } MOVE_SPEED;
/*
	Move Directions
*/
...
typedef enum { PS_UNPARKED, PS_PARKED, PS_UNPARKING, PS_PARKING,
	PS_PARK_LOST, PS_INITIALIZING, } TCES_PARK_STATUS;
...
typedef enum { TCEEE_NO_ERROR, TCEEE_LIMIT_HIT, TCEEE_USER_ABORT,
	...
	TCEEE_RA_COM_ERROR, TCEE_DEC_COM_ERROR  } TCE_EXTENDED_ERRORS;
...
*/
	...
	#if INCLUDE_TCE
	  extern "C" short __stdcall TCEDrvCommand(short command, void*Params, void*Results);
	#endif
	#if INCLUDE_STV
	  extern "C" short __stdcall STVDrvCommand(short command, void*Params, void*Results);
	#endif
  #else
	extern short __stdcall SBIGUnivDrvCommand(short command, void*Params, void*Results);
	#if INCLUDE_TCE
	  extern short __stdcall TCEDrvCommand(short command, void*Params, void*Results);
	#endif
	#if INCLUDE_STV
	  extern short __stdcall STVDrvCommand(short command, void*Params, void*Results);
	#endif
  #endif
#endif
