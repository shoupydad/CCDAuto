...
*/
#if defined(_MSC_VER)   /* Windows PCs; Visual C++, but not Borland C++ */
...
int __cdecl ffopentest(double version, fitsfile **fptr, const char *filename, int iomode, int *status);
...
int __cdecl ffinit(  fitsfile **fptr, const char *filename, int *status);
...
int __cdecl ffclos(fitsfile *fptr, int *status);
...
void ffcmsg(void);
void ffcmrk(void);
void __cdecl ffrprt(FILE *stream, int status);
...
int __cdecl ffgkyn(fitsfile *fptr, int nkey, char *keyname, char *keyval, char *comm,
           int *status);
int ffgkey(fitsfile *fptr, char *keyname, char *keyval, char *comm,
           int *status);
 
int __cdecl ffgky( fitsfile *fptr, int datatype, char *keyname, void *value,
           char *comm, int *status);
...
int ffgknl(fitsfile *fptr, char *keyname, int nstart, int nmax, int *value,
           int *nfound, int *status);
int __cdecl ffgknj(fitsfile *fptr, char *keyname, int nstart, int nmax, long *value,
           int *nfound, int *status);
...
/*--------------------- update keywords ---------------*/
int __cdecl ffuky(fitsfile *fptr, int datatype, char *keyname, void *value,
          char *comm, int *status);
...
int __cdecl ffcrim(fitsfile *fptr, int bitpix, int naxis, long *naxes, int *status);
...
int __cdecl ffgpv(fitsfile *fptr, int  datatype, LONGLONG firstelem, LONGLONG nelem,
          void *nulval, void *array, int *anynul, int  *status);
...
int ffppxnll(fitsfile *fptr, int datatype, LONGLONG *firstpix, LONGLONG nelem,
          void *array, void *nulval, int *status);
int __cdecl ffppr(fitsfile *fptr, int datatype, LONGLONG  firstelem,
